...
푸디는 AI와 데이터로 실제 문제를 분석하고, 그 결과를 프로토타입·대시보드·운영 시스템과 교육 콘텐츠로 만드는 빌더·컨설턴트입니다.
...
[GPTers](https://www.gpters.org/)는 챗GPT를 비롯한 AI 도구의 실제 활용 사례를 공유하고 함께 배우는 AI 커뮤니티입니다.
