...
- **한국어 지식 도구와 교육 콘텐츠** — 복잡한 분석을 비전문가도 실행하고 해석할 수 있게 정리합니다.
...
| **[real-estate-investment-analysis-with-claude-code](https://github.com/foodie-repository/real-estate-investment-analysis-with-claude-code)** | 『부동산 투자자를 위한 바이브 코딩 실전 가이드』 독자를 위한 수집·분석·대시보드 예제입니다. |
