...
<p align="center">
  <a href="https://foodie-repository.github.io/"><strong>포트폴리오와 아티클 보기 →</strong></a>
</p>
...
<p align="center">
  <img src="./assets/data-insight-kit.png" alt="data-insight-kit의 8단계 분석 흐름과 사람의 확인 지점을 설명한 구조도" width="100%" />
</p>
...
<p align="center">
  <a href="./case-studies/real-estate-dashboard-gallery.md"><strong>부동산 분석 대시보드 모음 보기 →</strong></a><br />
  <sub>지역·단지·평형·기간을 바꾸며 가격과 거래 흐름을 탐색하는 Dash 화면을 정리했습니다.</sub>
</p>
...
- **확장:** 지역과 기준월을 바꾸어 전국 시군구의 분석 대시보드를 같은 구조로 자동 생성할 수 있도록 설계
...
<p align="center">
  <img src="./assets/book-reader-journey.png" alt="처음 시작한 독자가 다섯 개의 부동산 분석 도구를 완성하는 학습 구조" width="100%" />
</p>
...
- **상세 사례:** [시장 데이터에서 후보 근거까지 이어지는 공유 현황판 보기](./case-studies/market-research-dashboard.md)

- **설계 원칙:** 개인 투자정보나 자동 매매 지시보다, 여러 근거와 위험 조건을 함께 비교하는 검토 도구에 초점을 맞췄습니다.
...
- **16기 태블로 스터디:** 태블로 기반 데이터 시각화 대시보드 제작
- **20·21기 부동산 AI 분석·에이전트 개발 스터디:** 부동산 AI 분석 워크스페이스 설계 및 AI Agent 개발
